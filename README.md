...
- Recently, the final deployment was done on **Heloku** platform and can be accessed from the link [https://banking-churn-pediction](https://banking-churn-pediction.herokuapp.com)
